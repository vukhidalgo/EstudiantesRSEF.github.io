...
<!-- BOTONES -->
      <div class="section">
        ...
        <div class="row">
          ...
          <div class="col s12 m3">
            <div class="row center">
              <a href="https://www.iaps.info/" id="inscripcion-button" target="_blank" class="btn-large waves-effect waves-light" style="background-color: rgb(41, 49, 132); border: 5px solid #B4B7D4; display: inline-flex; align-items: center;"><i class="material-icons">create</i>   Inscríbete</a>
            </div>
          </div>
        </div>
      </div>
