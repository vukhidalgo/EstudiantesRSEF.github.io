    ...
    <div class="card horizontal">
      ...
      <div class="card-content">
    	...
    	<div class="card-action">
            {% if event.facebook %}<a href="{{ event.facebook }}"><i class="svg-inline--fa fa-facebook-square fa-w-14"></i></a>{% endif %}
            ...
            {% if event.gallery %}<a href="{{ event.gallery }}"><i class="svg-inline--fa fa-camera-retro fa-w-16"></i></a>{% endif %}
