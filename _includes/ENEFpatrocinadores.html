<div class="section">
  ...
  <div class="row">	
    <div class="col s12 m6 l6">
	  ...
	  <div class="col s6 m6 l3">
      <img id="logo NFQ" class="materialboxed" width="100%" src="/img/eventos/2023-ENEF/Patrocinadores/NWorld.png" alt="NFQ">
    </div>
	</div>
	<h2>Colaboradores plata:</h2>
	<div class="row">
	  <div class="col s4 m4 l3">
      <img id="logo Cajastur" class="materialboxed" width="100%" src="/img/eventos/2023-ENEF/Patrocinadores/Cajastur.png" alt="Cajastur">
    </div>
	  <div class="col s4 m4 l3">
	  ...
	  <div class="col s4 m4 l3">
      <img id="logo ClusterTic" class="materialboxed" width="100%" src="/img/eventos/2023-ENEF/Patrocinadores/ClusterTic.png" alt="ClusterTic">
    </div>
	  <div class="col s4 m4 l3">
