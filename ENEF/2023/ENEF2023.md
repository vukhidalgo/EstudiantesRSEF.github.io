...
<!-- SPONSORS -->
      <div class="section">
        <div class="row">
          <div class="col s12 m6 l6">
            <p>Organiza:</p>
            <img id="logo GdeE" src="/img/logos/gdee-rsef.png" alt="Grupo de Estudiantes de la RSEF">
          </div>
          <div class="col s12 m6 l6">
            <p>Colabora:</p>
            <img id="logo EPS-YM" src="/img/EPS YM logo.jpg" alt="European Physical Society - Young Minds">
          </div>
        </div>
      </div>
