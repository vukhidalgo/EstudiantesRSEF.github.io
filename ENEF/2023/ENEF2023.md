...
<!-- PROGRAMA -->
	...
	<div class="col s6 m6 l3">
          <div class="row center">
            <a href="#inscribete" id="boton-programa" class="btn-large waves-effect waves-light" style="color:#000000;background-color:#E8C005">Conoce el programa detallado</a>
          </div>
        </div>
