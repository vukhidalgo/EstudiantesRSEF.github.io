    ...
    <div class="section">
      <div class="row">
        <div class="col s12 m6 l3">
          <div class="row center">
		        <a href="#Arriba" class="btn-large waves-effect waves-light" style="color:#323333;background-color:#E0C58B">Noticias</a>
          </div>
        </div>
        <div class="col s12 m6 l3">
          <div class="row center">
	    <a href="#Arriba" class="btn-large waves-effect waves-light" style="color:#323333;background-color:#E0C58B">Objetivos</a>
          </div>
        </div>
        <div class="col s12 m6 l3">
          <div class="row center">
            <a href="#Arriba" class="btn-large waves-effect waves-light" style="color:#323333;background-color:#E0C58B">Programa</a>
          </div>
        </div>
        <div class="col s12 m6 l3">
          <div class="row center">
            <a href="#Arriba" class="btn-large waves-effect waves-light" style="color:#323333;background-color:#E0C58B">Inscripción</a>
          </div>
        </div>
        <div class="col s12 m6 l3">
          <div class="row center">
            <a href="#Arriba" class="btn-large waves-effect waves-light" style="color:#323333;background-color:#E0C58B">Participantes</a>
          </div>
        </div>
        <div class="col s12 m6 l3">
          <div class="row center">
            <a href="#Arriba" class="btn-large waves-effect waves-light" style="color:#323333;background-color:#E0C58B">Localización</a>
          </div>
        </div>
        <div class="col s12 m6 l3">
          <div class="row center">
            <a href="#Arriba" class="btn-large waves-effect waves-light" style="color:#323333;background-color:#E0C58B">Q&A</a>
          </div>
        </div>
        <div class="col s12 m6 l3">
          <div class="row center">
            <a href="#Arriba" class="btn-large waves-effect waves-light" style="color:#323333;background-color:#E0C58B">Sponsors</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="section">
      <div class="row">
        <div class="col s12 m12">
          <h3>Las últimas noticias del ENEF</h3>
          <div class="blog-index">
            {% assign maxCountBlog = 3 %}
            {% assign countBlog = 0 %}
            {% for post in site.categories['enef'] %}
              {% if post.hidden != true and countBlog < maxCountBlog and post.title != "Encuentro Nacional de Estudiantes de Física 2023" %}
      ...
      <div class="row center">
           <a href="{{ site.url }}/ENEF2023/Noticias" id="about-button" class="btn-large waves-effect waves-light">Accede a todas las noticias del ENEF</a>
      </div>
    </div>
