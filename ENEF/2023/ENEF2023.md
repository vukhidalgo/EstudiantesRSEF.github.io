  ...
  <!-- BLOG -->
    <div class="section">
        ...
        <div class="col s12 m12">
          ...
          <div class="blog-index">
            ...
            {% for post in site.categories['enef'] %}
              {% if post.hidden != true and countBlog < maxCountBlog %}
      ...
      <div class="row center">
           <a href="{{ site.url }}/ENEF2023/Noticias" id="about-button" class="btn-large waves-effect waves-light">Accede a todas las noticias</a>
      </div>
    </div>
