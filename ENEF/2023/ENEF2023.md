...
<!-- BANNER -->
      <img class="materialboxed" width="100%" src="/img/eventos/2023-ENEF/Banner-4.png">
...
<!-- FOTOS -->
      <div class="section">
        <div class="row">
          <div class="col s6 m6 l3">
            <div class="row center">
              <img class="materialboxed" width="100%" src="/img/eventos/2023-ENEF/Foto-ICPS18Group.jpg">
            </div>
          </div>
          <div class="col s6 m6 l3">
            <div class="row center">
              <img class="materialboxed" width="100%" src="/img/eventos/2023-ENEF/Foto-ICPS19Spain.png">
            </div>
          </div>
          <div class="col s6 m6 l3">
            <div class="row center">
              <img class="materialboxed" width="100%" src="/img/eventos/2023-ENEF/Foto-ICPS19Evening.png">
            </div>
          </div>
	  <div class="col s6 m6 l3">
            <div class="row center">
              <img class="materialboxed" width="100%" src="/img/eventos/2023-ENEF/Foto-PLANCKS23UniOvi.jpg">
            </div>
          </div>
        </div>
      </div>
