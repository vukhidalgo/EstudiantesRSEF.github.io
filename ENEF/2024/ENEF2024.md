        ...
        <div class="row">
          <div class="col s6 m6 l3">
            <div class="row center">
              <a href="#objetivos" id="boton-objetivos" class="enef24 btn-large waves-effect waves-light">Objetivos</a>
            </div>
          </div>
          <!--<div class="col s6 m6 l3">
            <div class="row center">
...
<!-- OBJETIVOS -->
	  ...
	  <div class="col s12 m10 l8">
	    <div class="row center">
              <img class="materialboxed" width="100%" src="/img/eventos/2024-ENEF/ENEF24_logo2.png">
	    </div>
	  </div>
	  <div class="col s0 m1 l2">
	    <div class="row center"></div>
