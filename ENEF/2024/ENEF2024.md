...
<!-- BOTONES -->
      <div class="section">
        <div class="row">
          ...
          <!--<div class="col s6 m6 l3">
            <div class="row center">
              <a href="{{ site.url }}/ENEF2023/programa" id="boton-programa" class="btn-large waves-effect waves-light" style="color:#FFFFFF;background-color:#313FBB">Programa</a>
            </div>
          </div>-->
          <div class="col s6 m6 l3">
            <div class="row center">
	  ...
	  <div class="col s6 m6 l3">
	      ...
	      <a href="#preguntas" id="boton-preguntas" class="btn-large waves-effect waves-light" style="color:#FFFFFF;background-color:#313FBB">FAQs</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col s12 m6 l8">
            <div class="row">
              ...
              <p style="text-align: justify;">El ENEF se celebrará <strong>del -- al -- de julio en Granada</strong>. <!--Puedes consultar todo lo que haremos en la página del <a href="{{ site.url }}/ENEF2023/programa">programa</a>.--> Para los detalles logísticos, tod@s l@s asistentes van a recibir un correo la semana anterior al ENEF. Mientras tanto, consulta nuestras preguntas frecuentes para enterarte de todo.</p>
            </div>
          </div>
	...
	<p style="text-align: justify;">Además, debido al límite de participantes que tenemos, <strong>la inscripción no queda aceptada automáticamente, sino que tienes que esperar a nuestra confirmación por correo</strong>. A continuación te detallamos los pasos a seguir.</p>
	  ...
	  <div class="col s12 m4 l4">
          ...
          <div class="col s12 m6 l6">
            <div class="row center">
              <h2>Paso 2:</h2>
              <a href="{{ site.url }}/ENEF2023/inscripcion" target="_blank" class="btn-large waves-effect waves-light" style="color:#000000;background-color:#EFF1F4;border-color:#888888;border-width:4px">Inscripción ENEF</a>
      ...
      <div class="section">
        <div class="row">
          <div class="col s12 m6 l8">
            <div class="row">
              <h4 id="logistica">Logística</h4>
              <p style="text-align: justify;">El ENEF se celebrará <strong>del 26 al 29 de julio en Oviedo</strong>, capital de Asturias. Puedes consultar todo lo que haremos en la página del <a href="{{ site.url }}/ENEF2023/programa">programa</a>. Para los detalles logísticos, tod@s l@s asistentes van a recibir un correo la semana anterior al ENEF. Mientras tanto, consulta nuestras preguntas frecuentes para enterarte de todo.</p>
            </div>
          </div>
          <div class="col s12 m6 l4" style="padding: 20px">
            <img class="materialboxed" width="90%" src="/img/eventos/2023-ENEF/Logo.png">
