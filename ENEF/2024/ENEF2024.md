...
<!-- BOTONES -->
      <div class="section">
        <div class="row">
          ...
          <!--<div class="col s6 m6 l3">
            <div class="row center">
              <a href="{{ site.url }}/ENEF2023/programa" id="boton-programa" class="btn-enef24 waves-effect waves-light">Programa</a>
            </div>
          </div>-->
          <div class="col s6 m6 l3">
            <div class="row center">
...
<!-- OBJETIVOS -->
	  ...
	  <div class="col s12 m10 l8">
	    <div class="row center">
              <img class="materialboxed" width="100%" src="/img/eventos/2024-ENEF/Objetivos_ENEF24.png">
	    </div>
	  </div>
	  <div class="col s0 m1 l2">
	    <div class="row center"></div>
...
<!--      <div class="section">
	...
	<div class="col s6 m6 l3">
          <div class="row center">
            <a href="{{ site.url }}/ENEF2023/programa" id="boton-programa" class="btn-large waves-effect waves-light" style="color:#000000;background-color:#E8C005">Conoce el programa detallado</a>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col s12 m6 l8">
            <div class="row">
              ...
              <p style="text-align: justify;">El ENEF se celebrará <strong>del 3 al 7 de julio en Granada</strong>. <!--Puedes consultar todo lo que haremos en la página del <a href="{{ site.url }}/ENEF2023/programa">programa</a>.--> Para los detalles logísticos, tod@s l@s asistentes van a recibir un correo la semana anterior al ENEF. Mientras tanto, consulta nuestras preguntas frecuentes para enterarte de todo.</p>
            </div>
          </div>
...
<!-- CONCURSOS -->
      <div class="section">
		...
		<h3 id="concurso-tesis">¡Preséntame tu tesis en 5 minutos!</h3>
	 	...
	 	<h3 id="concurso-tesis">Concursos de posters</h3>
...
<!-- INSCRIPCIÓN -->
	...
	<p style="text-align: justify;">Además, debido al límite de participantes que tenemos, <strong>la inscripción no queda aceptada automáticamente, sino que tienes que esperar a nuestra confirmación por correo</strong>. A continuación te detallamos los pasos a seguir.</p>
	  ...
	  <div class="col s12 m4 l4">
          ...
          <div class="col s12 m6 l6">
            <div class="row center">
              <h2>Paso 2:</h2>
              <a href="{{ site.url }}/ENEF2023/inscripcion" target="_blank" class="btn-enef24 waves-effect waves-light">Inscripción ENEF</a>
	...
	<p style="text-align: justify;">¡Después de esto solo debes planear tu viaje hasta Granada y cargar pilas para vernos a finales de julio!</p>
